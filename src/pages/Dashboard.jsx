  ...
  return (
    <div className="w-screen h-screen">
     ...
     <NavBar/>
      ...
      <div className="content mt-9 md:mt-16 lg:mt-20 grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-3 pl-4 pr-4 lg:pl-4 lg:pr-4 md:pl-4 md:pr-4 bg-white">
        <div
        ...
        >
          <span className="  bg-orange-300 flex  justify-center  items-center rounded-full h-14 text-center  pt-2 w-14 border-4 text-4xl pb-2 lg:border-8 lg:w-24 lg:h-24 lg:text-6xl md:w-16 md:h-16 mr-4 outline ">
            <LiaStoreAltSolid />
          </span>
          <div className=" bg-orange pb-2">
        ...
        w-full h-24 lg:w-full lg:h-40 md:w-full md:h-24 ">
          <span className=" bg-primary flex  justify-center  items-center rounded-full h-14 text-center  pt-2 w-14 border-4 text-4xl pb-2 lg:border-8 lg:w-24 lg:h-24 lg:text-6xl md:w-16 md:h-16 outline">
            <GoArchive />
          </span>
        ...
        <div className="Total-store border-2 border-grey  flex justify-center items-center shadow-xl rounded-md decoration-primary
        w-full h-24 lg:w-full lg:h-40 md:w-full md:h-24  ">
          <span className="  bg-green-200 flex  justify-center  items-center rounded-full h-14 text-center  pt-2  border-4 text-5xl pb-2 lg:border-8 lg:w-24 lg:h-24 lg:text-5xl md:w-16 md:h-16  mr-4 outline">
            <FaUsers />
          </span>
          <div className=" ml-2 pb-4">
            <h1 className="  text-green-300 lg:text-2xl md:text-base sm:text-sm font-bold">Total User</h1>
            <p className=" text-green-300 lg:text-6xl md:text-4xl text-4xl font-bold">24</p>
          </div>
        </div>
        <div className="Total-store border-2 border-grey  flex justify-center items-center shadow-xl rounded-md decoration-primary
      ...
      <div className="">
        ...
        <div className="flex justify-between w-1/3 mt-4">
          ...
          <h2 className=" bg-primary relative inline-block w-28 rounded-lg pl-4 text-second text-xl lg:text-2xl md:text-2xl ml-2">Store</h2>
          <span className="absolute ml-20 pt-2 text-xl cursor-pointer text-second lg:pt-2 "><FaChevronDown /></span>
          </div>
        </div>
      </div>
